...
import 'package:quick_chat/module/views/profile/widgets/user_avatar.dart';
import 'package:quick_chat/module/views/profile/widgets/user_profile_info.dart';
    ...
    return Scaffold(
      ...
      body: Column(
        ...
        children: [
          ...
          ProfilePhotosGrid(email: user.email),
        ],
      ),
    );
  }
